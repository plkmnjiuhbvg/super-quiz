...
;joga-lo basta seguir alguns comandos simples, para comprar cartas, aumentar sua  ou prosseguir no jogo.
...
;assim possibilitando ao jogador antes da mesma revelar suas cartas compradas dobrar a  atual do jogo.
...
trocar : string "    Quer trocar quantas cartas ?"
suascartas : string " Suas cartas formam: "
somacasa : string " a casa conseguiu : "
...
primeira_rodada:
	...
	call ATUALIZARAND
	store carta2user, r7
	call VCIMPRIMIR5CARTAS									;mostras suas cinco cartas
	...
	store carta2maq, r7
	call Delay
	call IMPRIMIR5CARTAS									;mostras as cinco cartas da maquina/casa
	call Delay
	...
	;------------------------------------- final da rodada ------------------------------------------------------;
											...
											;pergunto pro usuario se ele quer dobrar a 
	call APAGALINHA_MEIO_ACIMA
...
segue_adiante: 			;---- aqui sera tratada 
	loadn r7, #48		; 0 em ascii
	loadn r0, #1143		; Posicao na tela onde a mensagem sera' escrita
		; Carrega r1 com o endereco do vetor que contem a mensagem
	loadn r2, #3328		; Seleciona a COR da Mensagem
	call Imprimestr
...
COMPARACARTASMAQUINA:
	...
	call PAR ; soma = c1 + c2
	call TRINCA ; soma = soma + c3
	call QUADRA
	call flush
	call straight
	call fullhouse
	call straightflush ; soma = soma + c4
	store somamaq, r0
	pop r7
	pop r6
	pop r5
